...
# function foward_defined_model(metnet::MetNet; kwargs...)

#     new_model = split_revs(metnet; kwargs...)

#     for rxni in eachindex(rxns(new_model))
#         isbkwd_bounded(new_model, rxni) || continue

#         lb, ub = bounds(new_model, rxni)
#         new_model.lb[rxni] = -ub
#         new_model.ub[rxni] = -lb
